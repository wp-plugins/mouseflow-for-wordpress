...
Description: Integrate Mouseflow analytics on your blog. Create a free account <a href="http://mouseflow.com" target="_blank">here</a>, and paste in your recording code <a href="options-general.php?page=mouseflow-wp-plugin/mouseflow-wp-plugin.php">here</a>.
Author: Mouseflow
Version: 1.0
...
function mouseflow_settings_link($links) { 
  $settings_link = '<a href="options-general.php?page=mouseflow-wp-plugin/mouseflow-wp-plugin.php">Settings</a>'; 
...
function mouseflow_menu() {
  add_options_page('Mouseflow', 'Mouseflow', 'administrator', __FILE__, 'mouseflow_options');
}
